namespace ChalinStore.Migrations
{
    using System;
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        CommentMsg = c.String(nullable: false, maxLength: 150),
                        CommentDate = c.DateTime(),
                        ProductId = c.Int(),
                        UserId = c.String(maxLength: 150),
                        ParenId = c.Int(),
                        Rate = c.String(nullable: false, maxLength: 150),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.tb_color", t => t.Color_Id, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductColors", "Color_Id", "dbo.tb_color");
            DropForeignKey("dbo.ProductColors", "Product_Id", "dbo.tb_Product");
